...
define(["jquery"], function ($) {
     ...
     *                           sole argument.
     */
    data.loadData_3 = function (from, winDuration, altMin, altMax, handler) {
        var till = new Date(from.getTime() + winDuration * 60000),
            fromStr = data.cartoDB.toString(from),
            tillStr = data.cartoDB.toString(till);
        //console.log("winDuration: " + winDuration);
        //console.log("from: " + from + " - till: " + till);
        var sql = "SELECT altitude, radar_id";
        ...
        sql += " ORDER BY altitude, radar_id";
